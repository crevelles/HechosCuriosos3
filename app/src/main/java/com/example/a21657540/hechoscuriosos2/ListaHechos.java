...
/**
 * Created by satan on 16/10/17.
 */

public class ListaHechos {

    String [] hechosCuriosos = {"Las hormigas se estiran cuando se despiertan por la mañana.",
    ...
    public String getHechoAleatoreo(){
        //Generamos el hecho de formaaleatorea
        Random randomGenerator = new Random();
        int randomNumber = randomGenerator.nextInt(hechosCuriosos.length);

        return hechosCuriosos[randomNumber];
    }
